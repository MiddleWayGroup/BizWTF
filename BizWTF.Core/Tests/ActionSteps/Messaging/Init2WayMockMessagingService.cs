...
{
    public class Init2WayMockMessagingService : ActionStep, IDisposable
    {
        ...
        public List<MessageResolutionSetting> ResolutionSettings
        {
            get
            {
                if (this._resolutionSettings == null)
                    this._resolutionSettings = new List<MessageResolutionSetting>();
                return this._resolutionSettings;
            }
            set { this._resolutionSettings = value; }
        }
        ...
        public Init2WayMockMessagingService()
            : base()
        { }

        public Init2WayMockMessagingService(string stepName)
            : base(stepName)
        {
        }
        ...
        public override bool ExecuteStep()
        {
            try
            {
                this.mockHost = new MessagingHost(this.ServiceURI, this.ResolutionSettings);
                this.AppendResultDescription(0, "Starting 2-Way mock service. Base Address : {0}", this.ServiceURI);
